...
@app.route('/mbti_match_detail/<counselor_name>')
def mbti_match_detail_html(counselor_name):
    child_id = session.get('child_id')    
    return render_template('user/mbti_match_detail.html', counselor_name=counselor_name)
